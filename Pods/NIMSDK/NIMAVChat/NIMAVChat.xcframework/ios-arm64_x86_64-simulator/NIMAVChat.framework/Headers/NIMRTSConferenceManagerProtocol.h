...
typedef void(^NIMRTSConferenceOperationFinishBlock) (NSError * _Nullable error);
 ...
 *
 */
- (void)leaveConference:(NIMRTSConference *)conference
            finishBlock:(NIMRTSConferenceOperationFinishBlock _Nullable)block;
