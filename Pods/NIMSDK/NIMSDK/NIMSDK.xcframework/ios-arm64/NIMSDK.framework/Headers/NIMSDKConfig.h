...
/**
 *  本地 log 最大占用空间（单位MB）
 *  @discusssion 默认为 200。只能设置大于等于 1 的值。
 */
@property (nonatomic,assign)    NSInteger   totalLogSizeInMB;

/**
 *  本地 log 每个分片最大大小（单位MB）
 *  @discusssion 默认为 10。只能设置大于等于 1 的值。
 */
@property (nonatomic,assign)    NSInteger   maxLogFileSizeInMB;

/**
 *  本地 log 是否压缩
 *  @discusssion 默认为 YES。
 */
@property (nonatomic,assign)    BOOL   archivedLogCompressionEnabled;
