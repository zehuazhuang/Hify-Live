 ...
 * 清空好友申请接口
 *
 * @param option  清除好友申请记录相关选项参数
 * @param success  请求成功回调
 * @param failure  请求失败回调
 */
- (void)clearAllAddApplicationEx:(V2NIMFriendClearAddApplicationOption *)option
                         success:(nullable V2NIMSuccessCallback)success
                         failure:(nullable V2NIMFailureCallback)failure;
 ...
 *
 */
@property (nullable,nonatomic,copy,readonly) NSString *serverId;
/**
 * 变更的时间
 **
 */
...
/**
 * 好友申请类型，默认V2NIM_FRIEND_ADD_APPLICATION_TYPE_TO_SELF
 */
@property (nonatomic, assign) V2NIMFriendAddApplicationType type;
@end
/**
 *  申请添加好友相关信息查询参数
 */
...
/// 附言类
/// 标识了附言来自于谁，什么时间产生的，以及内容是什么
@interface V2NIMPostscript: NSObject
/// 产生附言的账号
@property (nonatomic, copy, readonly) NSString *fromAccount;
/// 附言产生的时间
...
@interface V2NIMFriendClearAddApplicationOption : NSObject
